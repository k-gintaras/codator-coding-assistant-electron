...
export class CodingComponent {
  @Input() code = ''; // Receive the code from the parent
  @Output() codeChange = new EventEmitter<string>(); // Emit code changes back to the parent

  onCodeChange(): void {
    this.codeChange.emit(this.code); // Emit updated code to parent whenever it changes
  }
